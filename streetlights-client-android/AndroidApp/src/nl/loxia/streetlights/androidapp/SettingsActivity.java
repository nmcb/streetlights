...
public class SettingsActivity extends Activity {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if ((keyCode == KeyEvent.KEYCODE_BACK)) {
            ...
            prefsEditor.putString("ip_address", ipAddress.substring(0, ipAddress.lastIndexOf(".")+1) + ipAddressText.getText().toString());
            prefsEditor.commit();
     ...
     * @param ipAddress you received from WifiInfo()
     * @return IP Address
     */
